...
insert into Rental values (78912361, 'G214', '890', TO_DATE('2019-12-06','YYYY-MM-DD'), TO_TIMESTAMP('9:00', 'hh24:mi'), TO_DATE('2019-12-12','YYYY-MM-DD'), TO_TIMESTAMP('9:00', 'hh24:mi'), 17733, 'VISA', '1491027491026451', TO_DATE('2022-05-30','YYYY-MM-DD'), 234567890);
...
insert into Rental values (89012481, 'E901', '901', TO_DATE('2019-11-23','YYYY-MM-DD'), TO_TIMESTAMP('9:00', 'hh24:mi'), TO_DATE('2019-12-25','YYYY-MM-DD'), TO_TIMESTAMP('9:00', 'hh24:mi'), 12309, 'VISA', '1720488012389091', TO_DATE('2020-01-02','YYYY-MM-DD'), 120387410);
