...
insert into Customer values ('901', 'Dank', '8791246920', '8th GUI St');
...
insert into Reservation values (123456789, 'Bus', '234', TO_DATE('2019-09-12','YYYY-MM-DD'), TO_DATE('2019-09-15','YYYY-MM-DD'));
insert into Reservation values (234567890, 'Carriage', '567', TO_DATE('2019-12-06','YYYY-MM-DD'), TO_DATE('2019-12-12','YYYY-MM-DD'));
insert into Reservation values (345678901, 'Truck', '456', TO_DATE('2019-10-05','YYYY-MM-DD'), TO_DATE('2019-10-08','YYYY-MM-DD'));
insert into Reservation values (213941629, 'Bus', '890', TO_DATE('2019-12-31','YYYY-MM-DD'), TO_DATE('2020-01-02','YYYY-MM-DD'));
insert into Reservation values (120923819, 'Ambulance', '567', TO_DATE('2019-11-30','YYYY-MM-DD'), TO_DATE('2019-12-20','YYYY-MM-DD'));
insert into Reservation values (789154810, 'Van', '789', TO_DATE('2019-10-20','YYYY-MM-DD'), TO_DATE('2019-11-22','YYYY-MM-DD'));
insert into Reservation values (120387410, 'Standard', '901', TO_DATE('2019-11-23','YYYY-MM-DD'), TO_DATE('2019-12-25','YYYY-MM-DD'));
insert into Reservation values (809120377, 'Carriage', '901', TO_DATE('2018-10-24','YYYY-MM-DD'), TO_DATE('2019-11-29','YYYY-MM-DD'));
...
insert into Rental values (98765432, 'L019', '123', TO_DATE('2019-09-12','YYYY-MM-DD'), TO_DATE('2019-09-15','YYYY-MM-DD'), 74000, 'Master Card', '4819129071829990', TO_DATE('2021-10-22','YYYY-MM-DD'), 123456789);
insert into Rental values (78912361, 'G214', '890', TO_DATE('2019-12-06','YYYY-MM-DD'), TO_DATE('2019-12-12','YYYY-MM-DD'), 17733, 'VISA', '1491027491026451', TO_DATE('2022-05-30','YYYY-MM-DD'), 234567890);
insert into Rental values (90172461, 'H902', '890', TO_DATE('2019-10-05','YYYY-MM-DD'), TO_DATE('2019-10-08','YYYY-MM-DD'), 12388, 'VISA', '9731920162830017', TO_DATE('2020-02-28','YYYY-MM-DD'), 345678901);
insert into Rental values (80124742, 'V120', '567', TO_DATE('2019-12-31','YYYY-MM-DD'), TO_DATE('2020-01-02','YYYY-MM-DD'), 8000, 'Master Card', '0917829194230124', TO_DATE('2023-05-01','YYYY-MM-DD'), 213941629);
insert into Rental values (12893951, 'Y819', '234', TO_DATE('2019-11-30','YYYY-MM-DD'), TO_DATE('2020-12-20','YYYY-MM-DD'), 12000, 'Master Card', '9710475204778122', TO_DATE('2019-12-25','YYYY-MM-DD'), 120923819);
insert into Rental values (12972631, 'N991', '345', TO_DATE('2018-10-20','YYYY-MM-DD'), TO_DATE('2019-11-22','YYYY-MM-DD'), 21300, 'VISA', '9031638204720038', TO_DATE('2021-07-20', 'YYYY-MM-DD'), 789154810);
insert into Rental values (41709411, 'Y819', '123', TO_DATE('2019-08-27','YYYY-MM-DD'), TO_DATE('2019-09-15','YYYY-MM-DD'), 19237, 'VISA', '0983472023478994', TO_DATE('2022-07-12','YYYY-MM-DD'), null);
insert into Rental values (18297300, 'E000', '234', TO_DATE('2019-08-27','YYYY-MM-DD'), TO_DATE('2019-12-28','YYYY-MM-DD'), 13081, 'VISA', '7324962952030498', TO_DATE('2022-07-13','YYYY-MM-DD'), null);
insert into Rental values (41709410, 'P102', '789', TO_DATE('2019-08-27','YYYY-MM-DD'), TO_DATE('2019-12-21','YYYY-MM-DD'), 19221, 'Master Card', '6812949791277393', TO_DATE('2022-07-14','YYYY-MM-DD'), null);
insert into Rental values (41709413, 'G214', '890', TO_DATE('2019-08-27','YYYY-MM-DD'), TO_DATE('2019-09-15','YYYY-MM-DD'), 19291, 'Master Card', '6812949791289011', TO_DATE('2022-07-15','YYYY-MM-DD'), null);
insert into Rental values (89012481, 'E901', '901', TO_DATE('2019-11-23','YYYY-MM-DD'), TO_DATE('2019-12-25','YYYY-MM-DD'), 12309, 'VISA', '1720488012389091', TO_DATE('2020-01-02','YYYY-MM-DD'), 120387410);
